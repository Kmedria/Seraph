...
int Graphics::initWindow() {
    ...
    window = glfwCreateWindow(screenWidth, screenHeight, "Seraph", nullptr, nullptr);
    return 0;
}

int Graphics::initVulkan() {
    createInstance();
    setupDebugMessenger();
    createSurface();
    pickPhysicalDevice();
...
void Graphics::createInstance() {
    ...
    appInfo.pApplicationName = "Seraph";
...
void Graphics::createSwapChain() {
    ...
    uint32_t imageCount = (swapChainSupport.capabilities.minImageCount + 2 + swapChainSupport.capabilities.maxImageCount)/2;
